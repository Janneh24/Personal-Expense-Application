...
class ExpenseControllerTest {
    ...
    void testGetExpenseById() {
        ...
        Expense found = expenseController.getExpenseById(1L);
    ...
    void testGetExpenseByIdNotFound() {
        ...
        assertThatThrownBy(() -> expenseController.getExpenseById(1L))
    ...
    void testAddExpenseValid() {
        ...
        Expense result = expenseController.addExpense(e1);
    ...
    void testAddExpenseInvalidDescription() {
        ...
        assertThatThrownBy(() -> expenseController.addExpense(e1))
                .isInstanceOf(IllegalArgumentException.class);
        
        Expense e1Null = new Expense(0L, null, 10.0, "2023-01-01");
        assertThatThrownBy(() -> expenseController.addExpense(e1Null))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void testUpdateExpenseValid() {
        ...
        Expense result = expenseController.updateExpense(e1);
    ...
    void testUpdateExpenseInvalidId() {
        Expense e1 = new Expense(0L, "Desc", 10.0, "2023-01-01");
        assertThatThrownBy(() -> expenseController.updateExpense(e1))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void testAddCategoryValid() {
        ...
        Category result = expenseController.addCategory(c1);
        assertThat(result.getId()).isEqualTo(1L);
    }
    ...
    void testAddCategoryInvalid() {
        ...
        assertThatThrownBy(() -> expenseController.addCategory(c1))
                .isInstanceOf(IllegalArgumentException.class);
                
        Category c1Null = new Category(0L, null);
        assertThatThrownBy(() -> expenseController.addCategory(c1Null))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void testUpdateCategory() {
        ...
        Category result = expenseController.updateCategory(c1);
    ...
    void testUpdateCategoryInvalidName() {
        ...
        assertThatThrownBy(() -> expenseController.updateCategory(c1))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageContaining("Category name cannot be null or empty");
                
        Category c1Null = new Category(1L, null);
        assertThatThrownBy(() -> expenseController.updateCategory(c1Null))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageContaining("Category name cannot be null or empty");
    }
    ...
    void testGetExpensesByUserId() {
        ...
        List<Expense> result = expenseController.getExpensesByUserId(42L);
    ...
    void testGenerateReportEmpty() {
        ...
        String report = expenseController.generateReport(42L);
