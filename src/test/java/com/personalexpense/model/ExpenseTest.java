...
class ExpenseTest {
    ...
    void testExpenseProperties() {
        Expense expense = new Expense(1L, "Test", 10.5, "2023-01-01");
    ...
    void testEqualsAndHashCode() {
        Expense e1 = new Expense(1L, "Test", 10.5, "2023-01-01");
        Expense e2 = new Expense(1L, "Test", 10.5, "2023-01-01");
        Expense e3 = new Expense(2L, "Test2", 20.0, "2023-01-02");
    ...
    void testToString() {
        Expense expense = new Expense(1L, "Test", 10.5, "2023-01-01");
        assertThat(expense.toString()).contains("1", "Test", "10.5", "2023-01-01");
    }
}
